...
{
    public function __construct(private string $categoryPathFieldName)
    {
    }
    ...
    public function getSsrValue(CategoryEntity $categoryEntity): string
    {
        ...
        return sprintf('filter=%s', urlencode($this->categoryPathFieldName . ':' . $categoryPath));
    }

    private function encodeCategoryName(string $path): string
    {
        // important! do not modify this method
        return preg_replace('/\+/', '%2B', preg_replace(
            '/\//',
            '%2F',
