...
class TestConnectionController extends AbstractController
{
    ...
    #[Route('/api/_action/test-connection/api', name: 'api.action.fact_finder.test_api_connection', defaults: ['XmlHttpRequest' => true], methods: ['GET'])]
    ...
    #[Route('/api/_action/test-connection/ftp', name: 'api.action.fact_finder.test_ftp_connection', defaults: ['XmlHttpRequest' => true], methods: ['GET'])]
