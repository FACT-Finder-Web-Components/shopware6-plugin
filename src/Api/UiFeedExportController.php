...
class UiFeedExportController extends AbstractController
{
     ...
     * @throws \Exception
     */
    #[Route('/api/_action/fact-finder/generate-feed', name: 'api.action.fact_finder.export_feed', defaults: ['XmlHttpRequest' => true], methods: ['GET'])]
    ...
    #[Route('/api/_action/fact-finder/get-export-type-options', name: 'api.action.fact_finder.get_export_type_options', defaults: ['XmlHttpRequest' => true], methods: ['GET'])]
